...
export interface KrakenOhlcConnectionOptions {
  symbol: string;
  interval: number;
...
export class KrakenOhlcConnection {
  private ws: WebSocket | null = null;
  private reconnectTimer: ReturnType<typeof setTimeout> | null = null;
  private backoffMs = INITIAL_BACKOFF_MS;
  private stopped = false;
  private lastStatus: ConnectionStatus | null = null;
  private readonly options: KrakenOhlcConnectionOptions;

  constructor(options: KrakenOhlcConnectionOptions) {
  ...
  private openSocket(): void {
    ...
    ws.onerror = () => {
      ...
      // Defensive: schedule reconnect in case onclose does not follow (non-browser environments)
